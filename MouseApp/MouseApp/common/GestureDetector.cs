...
namespace MouseApp.common
{
    ...
    public class GestureDetector : IDisposable
    {
        ...
        private readonly string gestureDatabase = @"Database\MouseAppGestures.gbd";
        ...
        public GestureDetector(KinectSensor kinectSensor, string name)
        {
            ...
            // load the named gesture from the gesture database
            using (VisualGestureBuilderDatabase database = new VisualGestureBuilderDatabase(this.gestureDatabase))
            {
                ...
                {
                    int i = 1;
                    if (gesture.Name==this.gestureName)
                    {
                ...
                if(found == false)
                {
                    throw new ArgumentNullException("gestureName");
                }
            }
        }
